...
#读取彩色图
img=cv2.imread("C:/Users/lenovo/Desktop/image_image/test_image/image1.jpg")

#对彩色的图片进行灰度化操作，首先生成新图
gray_image1=cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)#COLOR_BGR2GRAY可以将彩色的图片转为灰度图

#保存已经灰度化好了的图片
cv2.imwrite("C:/Users/lenovo/Desktop/image_image/output_image/gray_image1.jpg", gray_image1)

#对灰度图片进行翻转，生成另外一张新图片，公式是255-c
gray_image2=255-gray_image1

#保存已经翻转好了的图片
cv2.imwrite("C:/Users/lenovo/Desktop/image_image/output_image/gray_image2.jpg", gray_image2)
